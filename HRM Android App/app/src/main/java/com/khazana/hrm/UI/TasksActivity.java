...
import com.khazana.hrm.Fragment.Tasks.AlltaskFragment;
import com.khazana.hrm.Fragment.Tasks.CompletedFragment;
import com.khazana.hrm.Fragment.Tasks.HighFragment;
import com.khazana.hrm.Fragment.Tasks.LowFragment;
import com.khazana.hrm.Fragment.Tasks.NormalFragment;
import com.khazana.hrm.Fragment.Tasks.PendingFragment;
import com.khazana.hrm.Fragment.Tasks.SevendaysFragment;
import com.khazana.hrm.Fragment.Tasks.TodayFragment;
...
import com.khazana.hrm.databinding.ActivityTasksBinding;
import com.khazana.hrm.databinding.DialogTaskcreateBinding;
    ...
    private BottomNavigationView.OnNavigationItemSelectedListener mOnNavigationItemSelectedListener
        ...
        switch (item.getItemId()) {
            ...
            case R.id.menu_more:
                ...
                Intent intentt = new Intent(TasksActivity.this, More.class);
...
//            dialog = new CustomProgressDialogue(TasksActivity.this);
...
//                                String msg = response.body().getMeta().getMessage();
                                Toast.makeText(TasksActivity.this, "Your session will be expired please login again! ", Toast.LENGTH_SHORT).show();
                                dialog.dismiss();
                                sessionManager.logoutUser();
                                Intent intent = new Intent(TasksActivity.this, SignIn.class);
                                startActivity(intent);
