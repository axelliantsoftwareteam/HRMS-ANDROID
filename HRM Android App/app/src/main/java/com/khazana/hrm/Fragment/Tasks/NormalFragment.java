...
import com.khazana.hrm.databinding.FragmentNormalBinding;
...
public class NormalFragment extends Fragment {
    ...
    private void GetAllTask(final String access_token) {
        try {
            ...
            dialog.show();
            Call<GetAlltask> getAllTaskModelCall = ApiHandler.getApiInterface().getnormalList("Bearer " + access_token);
