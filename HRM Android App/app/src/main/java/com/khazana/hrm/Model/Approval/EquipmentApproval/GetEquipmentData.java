...
//
//    public GetEquipmentData(int id, int status, String itemName, String comment) {
//        this.id = id;
//        this.status = status;
//        this.itemName = itemName;
//        this.comment = comment;
//    }
    ...
    public GetEquipmentData(int id, List<WorkFlow> workFlow, int status, String itemName, String comment) {
        this.id = id;
        this.workFlow = workFlow;
        this.status = status;
        this.itemName = itemName;
