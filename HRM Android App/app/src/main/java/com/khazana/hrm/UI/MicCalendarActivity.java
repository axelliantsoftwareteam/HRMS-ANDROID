...
import com.khazana.hrm.Adapter.Calender.CalenderEventAdapter;
import com.khazana.hrm.Adapter.CustomAdapter;
import com.khazana.hrm.Hundler.ApiHandler;
import com.khazana.hrm.Interface.OnCalenderDayClickListener;
...
import com.khazana.hrm.databinding.ActivityMicCalendarBinding;
import com.khazana.hrm.databinding.DialogCalendercreateBinding;
import com.khazana.hrm.databinding.DialogEventdetailsBinding;
import com.khazana.hrm.widget.CalendarCustomView;
    ...
    private BottomNavigationView.OnNavigationItemSelectedListener mOnNavigationItemSelectedListener
        ...
        switch (item.getItemId()) {
            ...
            case R.id.menu_more:
                ...
                Intent intentt = new Intent(MicCalendarActivity.this, More.class);
...
//        }
    ...
    public void getcalender(final String access_token) {
        try {
            ...
            dialog = new CustomProgressDialogue(MicCalendarActivity.this);
                    ...
                    try {
                        if (response.isSuccessful()) {
                            ...
                            if (status == 200) {
                                ...
                                Toast.makeText(MicCalendarActivity.this, "" , Toast.LENGTH_SHORT).show();
                                dialog.dismiss();
                                sessionManager.logoutUser();
                                Intent intent = new Intent(MicCalendarActivity.this, SignIn.class);
                                startActivity(intent);
                                finish();
                            }
...
//                                String msg = response.body().getMeta().getMessage();
                                Toast.makeText(MicCalendarActivity.this, "Your session will be expired please login again! ", Toast.LENGTH_SHORT).show();
                                dialog.dismiss();
                                sessionManager.logoutUser();
                                Intent intent = new Intent(MicCalendarActivity.this, SignIn.class);
                                startActivity(intent);
                                ...
                                String msg = response.body().getMeta().getMessage();
                                Toast.makeText(MicCalendarActivity.this, " "+msg, Toast.LENGTH_SHORT).show();
                                dialog.dismiss();
