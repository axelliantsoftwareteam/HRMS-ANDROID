...
public class ApprovalEquipmentAdapter extends RecyclerView.Adapter<ApprovalEquipmentAdapter.MyViewHolder> {
    Context context;

    GetEquipmentData attendApproval;
    private List<GetEquipmentData> attendApprovalList;
    private OnItemClickListener mOnItemClickListener;



    public interface OnItemClickListener {
        void onItemClick(View view, GetEquipmentData obj, int position);
    }
    ...
    public ApprovalEquipmentAdapter(Context context, List<GetEquipmentData> respons) {
    ...
    public MyViewHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
        View v = LayoutInflater.from(parent.getContext())
                .inflate(R.layout.ly_equiptappr, parent, false);
