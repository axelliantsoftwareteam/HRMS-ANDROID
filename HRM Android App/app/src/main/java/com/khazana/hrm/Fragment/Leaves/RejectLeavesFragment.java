...
import com.khazana.hrm.Adapter.Leaves.RejectLeavesAdapter;
...
public class RejectLeavesFragment extends Fragment {



    private RecyclerView mRecyclerView;
    private RecyclerView.LayoutManager mLayoutManager;
    RejectLeavesAdapter rejectLeavesAdapter;
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        View view= inflater.inflate(R.layout.fragment_reject_leaves, container, false);
        noleave = view.findViewById(R.id.txt_no);

        mRecyclerView = view.findViewById(R.id.ly_reject);
        ...
        GetRejectedLeaves(token);



        return view;
    }
    private void GetRejectedLeaves(final String access_token) {
        try {
...
//            params.put("search", "nullli");
            ...
            Call<AllLeavesModel> allleaves = ApiHandler.getApiInterface().getrejected("Bearer " + access_token);
                        ...
                        if (response.isSuccessful()) {
                            ...
                            if (status == 200)
                            {
                                ...
                                if (leaves.size()==0)
                                {
                                    ...
                                    rejectLeavesAdapter = new RejectLeavesAdapter(getActivity(), leaves);
                                    mRecyclerView.setAdapter(rejectLeavesAdapter);
