...
public class ApprovLeavesAdapter extends RecyclerView.Adapter<ApprovLeavesAdapter.MyViewHolder> {
    Context context;
    Leaves leaves;
    ...
    public ApprovLeavesAdapter(Context context, List<Leaves> leaves) {
...
//            edit = v.findViewById(R.id.edit);
    ...
    @NonNull
    @Override
    public ApprovLeavesAdapter.MyViewHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
        View v = LayoutInflater.from(parent.getContext())
                .inflate(R.layout.lay_apprleaves, parent, false);

        ApprovLeavesAdapter.MyViewHolder vh = new ApprovLeavesAdapter.MyViewHolder(v);

        return vh;
    }

    @Override
    public void onBindViewHolder(@NonNull final ApprovLeavesAdapter.MyViewHolder holder, int position) {
