...
import com.khazana.hrm.Model.LeavesModel.WorkFlow;
import com.khazana.hrm.R;

import java.util.List;

public class PendingLeavesAdapter extends RecyclerView.Adapter<PendingLeavesAdapter.MyViewHolder> {
    Context context;
    Leaves leaves;
    ...
    public PendingLeavesAdapter(Context context, List<Leaves> leaves) {
...
//            edit = v.findViewById(R.id.edit);
    ...
    @NonNull
    @Override
    public PendingLeavesAdapter.MyViewHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
        View v = LayoutInflater.from(parent.getContext())
                .inflate(R.layout.lay_pendleaves, parent, false);

        PendingLeavesAdapter.MyViewHolder vh = new PendingLeavesAdapter.MyViewHolder(v);

        return vh;
    }

    @Override
    public void onBindViewHolder(@NonNull final PendingLeavesAdapter.MyViewHolder holder, int position) {
