...
import com.khazana.hrm.databinding.ActivityUserProfBinding;
...
public class UserProfActivity extends AppCompatActivity {
    ...
    private BottomNavigationView.OnNavigationItemSelectedListener mOnNavigationItemSelectedListener
        ...
        switch (item.getItemId()) {
            case R.id.menu_me:
//                Intent intent = new Intent(UserProfActivity.this, UserProfActivity.class);
...
//                finish();
            ...
            case R.id.menu_more:
              //  item.getIcon().setTint(ContextCompat.getColor(UserProfActivity.this, R.color.white));
               item.getIcon().setTint(ContextCompat.getColor(UserProfActivity.this,R.color.white));
                Intent intentt = new Intent(UserProfActivity.this, More.class);
