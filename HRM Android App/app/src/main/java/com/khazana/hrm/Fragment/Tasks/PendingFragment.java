...
import com.khazana.hrm.databinding.FragmentPendingBinding;
...
public class PendingFragment extends Fragment {
    ...
    private void GetAllTask(final String access_token) {
        try {
            ...
            dialog.show();
            Call<GetAlltask> getAllTaskModelCall = ApiHandler.getApiInterface().getpendingList("Bearer " + access_token);
