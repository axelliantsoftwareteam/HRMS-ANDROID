...
public class RejectLeavesAdapter extends RecyclerView.Adapter<RejectLeavesAdapter.MyViewHolder> {
    Context context;
    Leaves leaves;
    ...
    public RejectLeavesAdapter(Context context, List<Leaves> leaves) {
...
//            edit = v.findViewById(R.id.edit);
    ...
    @NonNull
    @Override
    public RejectLeavesAdapter.MyViewHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
        View v = LayoutInflater.from(parent.getContext())
                .inflate(R.layout.lay_rejectleaves, parent, false);

        RejectLeavesAdapter.MyViewHolder vh = new RejectLeavesAdapter.MyViewHolder(v);

        return vh;
    }

    @Override
    public void onBindViewHolder(@NonNull final RejectLeavesAdapter.MyViewHolder holder, int position) {
