...
import com.khazana.hrm.Adapter.Attendance.AttendanceDayHeaderAdapter;
import com.khazana.hrm.Adapter.Attendance.DayDateAdapter;
import com.khazana.hrm.Adapter.Attendance.EmployeeAttendanceAdapter;
import com.khazana.hrm.Adapter.Attendance.EmployeeNamesAdapter;
import com.khazana.hrm.Adapter.Attendance.GetUserAttendanceAdapter;
import com.khazana.hrm.Adapter.CustomAdapter;
...
import com.khazana.hrm.Model.CalenderEventObjects;
...
import com.khazana.hrm.databinding.ActivityAttendanceBinding;
import com.khazana.hrm.databinding.DialogAttendenanceStatusBinding;
    ...
    private BottomNavigationView.OnNavigationItemSelectedListener mOnNavigationItemSelectedListener
        ...
        switch (item.getItemId()) {
            ...
            case R.id.menu_more:
                ...
                Intent intentt = new Intent(AttendanceActivity.this, More.class);
...
//            attendance.setEmployeeList(null);
            ...
            dialog = new CustomProgressDialogue(AttendanceActivity.this);
...
//                                RecyclerViewday.setVisibility(View.VISIBLE);
                                ...
                                Toast.makeText(AttendanceActivity.this, "Your session is expired please login again", Toast.LENGTH_SHORT).show();
                                dialog.dismiss();
                                sessionManager.logoutUser();
                                Intent intent = new Intent(AttendanceActivity.this, SignIn.class);
                                startActivity(intent);
...
//                Toast.makeText(AttendanceActivity.this, ""+id, Toast.LENGTH_SHORT).show();
