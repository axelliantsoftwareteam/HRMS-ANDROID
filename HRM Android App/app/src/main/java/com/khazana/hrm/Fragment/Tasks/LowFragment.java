...
import com.khazana.hrm.databinding.FragmentLowBinding;
...
public class LowFragment extends Fragment {
    ...
    private FragmentLowBinding binding;
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        binding = FragmentLowBinding.inflate(inflater, container, false);
    ...
    private void GetAllTask(final String access_token) {
        try {
            ...
            dialog.show();
            Call<GetAlltask> getAllTaskModelCall = ApiHandler.getApiInterface().getlowList("Bearer " + access_token);
