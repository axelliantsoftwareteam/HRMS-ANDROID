...
public class RequestGeneralAdapter extends RecyclerView.Adapter<RequestGeneralAdapter.MyViewHolder> {
    Context context;
    ...
    public RequestGeneralAdapter(Context context, List<Equipment> equipment) {
...
//        public TextView approved;
        public LinearLayout status,approv,reject,pend;
...
//            edit = v.findViewById(R.id.edit);
    ...
    public MyViewHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
        View v = LayoutInflater.from(parent.getContext())
                .inflate(R.layout.lay_generalreq, parent, false);
