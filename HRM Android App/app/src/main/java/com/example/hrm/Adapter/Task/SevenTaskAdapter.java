...
public class SevenTaskAdapter extends RecyclerView.Adapter<SevenTaskAdapter.MyViewHolder> {
    Context context;
    GetSevendayData getAllTaskData;
    private List<GetSevendayData> getAllTaskDataList;
    private SevenTaskAdapter.OnItemClickListener mOnItemClickListener;

    public interface OnItemClickListener {
        void onItemClick(View view, GetSevendayData obj, int position);
    }

    public void setOnItemClickListener(final SevenTaskAdapter.OnItemClickListener mItemClickListener) {
        this.mOnItemClickListener = (SevenTaskAdapter.OnItemClickListener) mItemClickListener;
    }
    public SevenTaskAdapter(Context context, List<GetSevendayData> respons) {
